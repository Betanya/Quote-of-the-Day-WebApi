	...
	if (as_clicked('SignMeUp')) {
		...
		if (empty($fielderrors)) {
			...
			if($as_errflag) {
				...
				header( "Location: ".as_siteUrl."signup".as_urlExt."?as_request=signup_failed");
				exit();
			}
			...
			header( "Location: ".as_siteUrl."index".as_urlExt."?as_request=signup_succeded");
		} else {
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">If you already have an Account with us please consider <a href="signin.html">Signing In</a></p>
							<?php if( isset($_SESSION['AS_ERRMSG_ARR']) && is_array($_SESSION['AS_ERRMSG_ARR']) && count($_SESSION['AS_ERRMSG_ARR']) >0 ) { ?>
