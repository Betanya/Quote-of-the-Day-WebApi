<?php 
	$as_pageinfo = array();
	$as_pageinfo['pageTitle'] = "Latest Quote Categories";
          ...
          <div class="row">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">                    
                    <a href="?as_request=quote_category_new" class="btn btn-box-tool"><i class="fa fa-plus"></i></a>
                ...
                <div class="box-body">
                  ...
                  <?php $as_db_query = "SELECT * FROM as_quote_category ORDER BY categoryid DESC LIMIT 20";
					//$database = new As_Dbconn();
		        ...
		        <tr onclick="location='as_request=quote_category_view&amp;as_quote_categoryid=<?php echo $row['categoryid'] ?>'">       
					<td><img class="iconic" src="<?php echo as_siteUrl.'as_media/posts/'.$row['category_icon'] ?>" /></td>
					<td><?php echo $row['category_title'] ?></td>
					<td><?php echo $row['category_content'] ?></td>
					<td><?php echo as_total_category_quotes($row['categoryid']) ?></td>
		        </tr>
			...
			<?php } ?>
                ...
                <div class="box-footer clearfix">
                  <a href="?as_request=quote_category_new" class="btn btn-sm btn-info btn-flat pull-left">Add New Category</a>
