                    ...
                    <form class="form-horizontal" role="form" method="post" name="PostPage" action="<?php echo $as_pageinfo['formAction'] ?>" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          <input name="UpdateItem" class="btn btn-primary form-control" type="submit" value="Update Page" />
                          <input name="UnpublishItem" class="btn btn-danger" type="submit" class="form-control" value="Unpublish Page" />
                          <input name="DeleteItem" class="btn btn-danger" type="submit" class="form-control" value="Delete Page" />
                        </div>
                      </div>
                    </form>
                  </div><!-- /.tab-pane -->
