          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo as_adminUrl ?>?as_request=user_all"><i class="fa fa-circle-o"></i> View All Members</a></li>
                <li><a href="<?php echo as_adminUrl ?>?as_request=user_client"><i class="fa fa-circle-o"></i> View Clients</a></li>
                <li><a href="<?php echo as_adminUrl ?>?as_request=user_admin"><i class="fa fa-circle-o"></i> View Admins</a></li>
              </ul>
            </li>
                        <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo as_adminUrl ?>?as_request=quote_new"><i class="fa fa-plus"></i> New Quote</a></li>
                <li><a href="<?php echo as_adminUrl ?>?as_request=quote_all"><i class="fa fa-circle-o"></i> View Quotes</a></li>
				<li><a href="<?php echo as_adminUrl ?>?as_request=quote_category_new"><i class="fa fa-plus"></i> New Category</a></li>
                <li><a href="<?php echo as_adminUrl ?>?as_request=quote_category_all"><i class="fa fa-circle-o"></i> View Categories</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
