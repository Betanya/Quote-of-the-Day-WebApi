				  ...
				  <div class="box-body">
					<div class="row">
					  ...
					  <div class="col-lg-6">	
						...
						<div class="form-group">
							<input name="Slideshow1" class="btn btn-primary form-control" type="submit" value="Save Changes" />
						</div>
					  </div>
					</div>
				 </div>
				  ...
				  <div class="box-body">
					<div class="row">
					  ...
					  <div class="col-lg-6">	
						...
						<div class="form-group">
							<input name="Slideshow2" class="btn btn-primary form-control" type="submit" value="Save Changes" />
						</div>
					  </div>
					</div>
				 </div>
				  ...
				  <div class="box-body">
					<div class="row">
					  ...
					  <div class="col-lg-6">	
						...
						<div class="form-group">
							<input name="Slideshow3" class="btn btn-primary form-control" type="submit" value="Save Changes" />
						</div>
					  </div>
					</div>
				 </div>
				  ...
				  <div class="box-body">
					<div class="row">
					  ...
					  <div class="col-lg-6">	
						...
						<div class="form-group">
							<input name="Slideshow4" class="btn btn-primary form-control" type="submit" value="Save Changes" />
						</div>
					  </div>
					</div>
				 </div>
