						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="row">
								 <div class="col-md-6">
									<div class="form-group">
										<input name="SaveClose" class="btn btn-primary form-control" style="float:right;" type="submit" value="Save & Close" />
									</div>
								</div>
								
								<div class="col-md-6">
									<div class="form-group">
										<input name="SaveAdd" class="btn btn-primary form-control" type="submit" value="Save & Add" />
									</div>
								</div>
